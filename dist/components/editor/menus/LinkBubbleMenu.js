...
var LinkBubbleMenu = function LinkBubbleMenu(_ref) {
  ...
  var _useState3 = (0, _react.useState)(false),
    ...
    showEmbedBtn = _useState4[0],
    setShowEmbedBtn = _useState4[1];
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("".concat(editor.storage.richerTextEmbed.embedPath, "/patterns"));
            case 2:
  ...
  var createEmbed = function createEmbed(url) {
    ...
    fetch("".concat(editor.storage.richerTextEmbed.embedPath), {
      method: 'POST',
      headers: {
  ...
  var embedSelected = function embedSelected(event, url) {
    event.preventDefault();
    createEmbed(url);
  };
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    ref: linkInputRef
  }), editor.options.editorProps.enableEmbeds == "true" && /*#__PURE__*/_react["default"].createElement(_headless["default"], {
    render: function render() {
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: "richer-text-editor--edit-menu"
      }, /*#__PURE__*/_react["default"].createElement("button", {
        onClick: function onClick(event) {
          return embedSelected(event, linkInputRef.current.value);
        }
      }, "Embed instead"));
    },
    interactive: true,
    ...
    onClick: onSubmit
  }, "Done")), editor.options.editorProps.enableEmbeds != "true" && /*#__PURE__*/_react["default"].createElement("button", {
    onClick: onSubmit
  }, "Done")));
};
