...
var MenuList = /*#__PURE__*/function (_BaseList) {
  _inherits(MenuList, _BaseList);
  ...
  _createClass(MenuList, [{
    ...
    value: function render() {
      ...
      return (0, _lit.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <div class=\"suggested-items\">\n        ", "\n      </div>\n    "])), this.items.length > 0 ? this.items.map(function (item, index) {
        ...
        }, item.iconName ? (0, _lit.svg)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["", ""])), _icons["default"].get(item.iconName)) : "", item.label);
