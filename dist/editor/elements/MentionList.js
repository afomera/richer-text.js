...
var MentionList = /*#__PURE__*/function (_LitElement) {
  _inherits(MentionList, _LitElement);
  ...
  _createClass(MentionList, [{
    ...
    value: function render() {
      ...
      return (0, _lit.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <div class=\"suggested-items\">\n        ", "\n      </div>\n    "])), this.items.length > 0 ? this.items.map(function (item, index) {
        return (0, _lit.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n            <button\n              class=\"suggested-item ", "\"\n              @click=", "\n            >\n              ", "\n              ", "\n            </button>"])), index === _this2.selectedIndex ? 'is-selected' : '', function () {
          return _this2.selectItem(index);
        }, item.avatarUrl ? (0, _lit.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<img src=", " width=\"24\" height=\"24\" alt=", " />"])), item.avatarUrl, item.label) : "", item.label);
      }) : (0, _lit.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<div class=\"suggested-item\">No results</div>"]))));
    }
  }, {
    key: "onKeyDown",
...
_defineProperty(MentionList, "styles", (0, _lit.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    .suggested-items {\n      padding: 0.2rem;\n      position: relative;\n      border-radius: 0.5rem;\n      background: #fff;\n      color: rgba(0, 0, 0, 0.8);\n      overflow: hidden;\n      font-size: 0.9rem;\n      box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.05), 0px 10px 20px rgba(0, 0, 0, 0.1);\n    }\n    .suggested-item {\n      display: flex;\n      align-items: center;\n      margin: 0;\n      width: 100%;\n      text-align: left;\n      background: transparent;\n      border-radius: 0.4rem;\n      border: 1px solid transparent;\n      padding: 0.2rem 0.4rem;\n\n      img {\n        border-radius: 50%;\n        margin-right: 0.4rem;\n      }\n    }\n    .suggested-item.is-selected {\n      border-color: #000;\n    }\n  "]))));
_defineProperty(MentionList, "properties", {
  items: {
    type: Array
  },
  selectedIndex: {
