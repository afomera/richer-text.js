...
var MentionSuggestion = function MentionSuggestion(mentionableUsersPath) {
  return {
    "char": "@",
    pluginKey: new _state.PluginKey("MentionSuggestion"),
    items: function () {
      var _items = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              url = new URL(mentionableUsersPath, window.location.origin);
              if (query) {
...
var _default = MentionSuggestion;
